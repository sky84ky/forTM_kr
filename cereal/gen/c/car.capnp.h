...
enum cereal_CarControl_HUDControl_AudibleAlert {
	...
	cereal_CarControl_HUDControl_AudibleAlert_chimeStartup = 8,
	cereal_CarControl_HUDControl_AudibleAlert_chimeDistracted = 9,
	cereal_CarControl_HUDControl_AudibleAlert_chimeLkas = 10,
	cereal_CarControl_HUDControl_AudibleAlert_chimeVision = 11
};
