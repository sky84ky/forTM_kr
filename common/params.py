...
keys = {
  ...
  "INDIOuterLoopGain": [TxType.PERSISTENT],
  "INDIInnerLoopGain": [TxType.PERSISTENT],
  "INDITimeConstant": [TxType.PERSISTENT],
  "INDIActuatorEffectiveness": [TxType.PERSISTENT],
  "LQRScale": [TxType.PERSISTENT],
  "LQRKi": [TxType.PERSISTENT],
  "LQRDcGain": [TxType.PERSISTENT],
  "PIDIgnoreZone": [TxType.PERSISTENT],
